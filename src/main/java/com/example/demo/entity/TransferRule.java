...
setMinimumOverlapPercentage(minimumOverlapPercentage);
setCreditHourTolerance(creditHourTolerance);
this.active = true;
}
...
if (minimumOverlapPercentage == null
|| minimumOverlapPercentage < 0
|| minimumOverlapPercentage > 100) {
throw new RuntimeException("minimumOverlapPercentage must be 0-100");
}
...
if (creditHourTolerance == null || creditHourTolerance < 0) {
throw new RuntimeException("creditHourTolerance must be >= 0");
}
